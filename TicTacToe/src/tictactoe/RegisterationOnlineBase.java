...
public class RegisterationOnlineBase extends Pane {
    ...
    public RegisterationOnlineBase(Stage s) {
        ...
        registerBtn.setPrefHeight(31.0);
        registerBtn.setPrefWidth(95.0);
        ...
        registerBtn.setOnAction((event) -> {
          boolean result= DataAccessLayer.Register(userNameTxtField.getText(),passwordTxtField.getText(),emailTxtField.getText());
           if (!result){
